...
//        index.html -> app.js -> pkg/{{crate_name}}_web.js -> *_bg.wasm
...
const wasmName = emitHashed("pkg/{{crate_name}}_web_bg.wasm");
const pkgJsName = emitHashed("pkg/{{crate_name}}_web.js", [
  ["{{crate_name}}_web_bg.wasm", wasmName],
]);
const appJsName = emitHashed("app.js", [
  ["./pkg/{{crate_name}}_web.js", `./${pkgJsName}`],
]);
